...
for i in range(count):
    ...
    model = SpGAT_1_1(nfeat=features.shape[1],
                  nhid=args.hidden1,
    ...
    def train(epoch):
        ...
        uns2_loss_train = F.mse_loss(output_sub,output_unsupervised)

        loss_train = (1 - alpha) * su_loss_train + alpha * uns_loss_train + beta * uns2_loss_train
        ...
        loss_val = (1 - alpha) * F.nll_loss(output_supervised[idx_val], labels[idx_val]) \
            ...
            + beta * F.mse_loss(output_sub,output_unsupervised)
