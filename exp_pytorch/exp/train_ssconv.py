...
# parser.add_argument('--model', type=str, default='GCN_SS',help='Model string')
# ####################### additional #############################
...
#
#     #features = torch.cat([features, struc_feat], 1)
#     #print(features.size())
#     #print(features)
...
#
#     if args.model == 'GCN_SS':
#         model = GCN_SS(nfeat=features.shape[1],
#                        nhid=args.hidden1,
#                        nclass=labels.max().item() + 1,
#                        dropout=args.dropout,
#                        nstruc=struc_feat.shape[1],
#                        relu_a=args.relu_a)
#     elif args.model == 'GAT_SS':
#         model = GAT_SS(nfeat=features.shape[1],
#                       nhid=args.hidden1,
#                       nclass=labels.max().item() + 1,
#                       dropout=args.dropout,
#                       nstruc=struc_feat.shape[1],
...
#         model.train()
#         optimizer.zero_grad()
#         su_loss_train, uns_loss_train, output_supervised = model(features, adj, struc_feat, idx_train, labels)
#         # print(su_loss_train)
#         # print(uns_loss_train)
#         # print()
...
#             model.eval()
#             su_loss_val, uns_loss_val,output_supervised = model(features, adj, struc_feat, idx_val, labels)
#
#         loss_val = (1 - alpha) * su_loss_val + alpha * uns_loss_val
...
#         model.eval()
#
#         su_loss_test, uns_loss_test,output_supervised = model(features, adj,struc_feat, idx_val, labels)
#         loss_test = (1 - alpha) * su_loss_test + alpha * uns_loss_test
