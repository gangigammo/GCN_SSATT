...
# parser.add_argument('--model', type=str, default='GCN_attentionSS',help='Model string')
# ####################### additional #############################
...
#
#     if args.model == 'GCN_attentionSS':
#         model = GCN_attentionSS(nfeat=features.shape[1],
#                        nhid=args.hidden1,
...
#
#         optimizer.zero_grad()
#         output_supervised, output_unsupervised,ss = model(features, adj,struc_feat)
#
...
#         uns_loss_train = F.mse_loss(output_unsupervised, ss)
#
#         #print(su_loss_train)
...
#             + alpha * F.mse_loss(output_unsupervised, ss)
